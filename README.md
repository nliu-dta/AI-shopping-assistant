...
1.  **Google Maps API** (Cloud Console): Enable "Places API (New)".
2.  **Google Gemini API** (Google AI Studio): Get a free API key.
3.  **SerpAPI**: Sign up for a free account (100 searches/month).
